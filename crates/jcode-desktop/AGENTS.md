# Fusion Forge Desktop Agent Context

- This directory is the Fusion Forge desktop application crate. When a desktop-launched agent opens here, assume self-development work is focused on the desktop application unless the user says otherwise.
